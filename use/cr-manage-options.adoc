...
* link:../use/manage-apps.html#tech-preview-define-an-application-using-a-kubernetes-custom-resource["Defina una aplicación con un recurso personalizado de Kubernetes"]
* link:../use/manage-buckets.html#tech-preview-manage-a-bucket-using-a-custom-resource["Gestione un bloque utilizando un recurso personalizado"]
