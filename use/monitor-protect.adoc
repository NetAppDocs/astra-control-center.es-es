...
NOTE: Las conexiones de Fluentd no son compatibles con clústeres gestionados con flujos de trabajo de Kubernetes declarativos. Solo puede conectar Fluentd a clústeres gestionados con flujos de trabajo que no sean nativos de Kubernetes.
