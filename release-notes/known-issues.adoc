...
Después de actualizar a Astra Control Center 23.04.2, es posible que algunos pods muestren un error en los registros relacionados con `task-service-task-purge`:
