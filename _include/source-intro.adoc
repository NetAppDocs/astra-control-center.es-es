...
Astra Control Center admite clústeres de Kubernetes con un tipo de almacenamiento basado en Trident con un back-end de almacenamiento ONTAP 9,5 y posterior.
