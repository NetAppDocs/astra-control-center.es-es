...
+
** Para los clústeres de GKE, Astra Control Service usa  https://www.netapp.com/google-cloud/netapp-volumes/["Cloud Volumes Service de NetApp para Google Cloud"^] o Google Persistent Disks como backend de almacenamiento para tus volúmenes persistentes.
** Para los clústeres de AKS, Astra Control Service usa  https://www.netapp.com/azure/azure-netapp-files/["Azure NetApp Files"^] o discos administrados por Azure como backend de almacenamiento para tus volúmenes persistentes.
