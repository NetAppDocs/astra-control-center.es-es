...
| Anthos de Google | 1,14 a 1,16 (consulte <<Requisitos de incorporación de Google Anthos>>) 


| Kubernetes (ascendente) | 1,25 a 1,27 (se requiere Astra Trident 22,10 o posterior para Kubernetes 1,25 o posterior) 
...
* *Versión mínima para usar con Astra Control Center*: Astra Trident 22,10 o posterior instalado y configurado.
* *Replicación de SnapMirror*: Astra Trident 22,10 o posterior instalado para la replicación de aplicaciones basada en SnapMirror.
...
Cuando usa NetApp MetroCluster como back-end de almacenamiento, debe especificar una LIF de gestión de SVM como opción back-end en el controlador de Astra Trident que utilice.
