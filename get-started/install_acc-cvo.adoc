...
Consulte https://["Credenciales iniciales de AWS"^].
...
Para obtener instrucciones de instalación, consulte https://["Instalación de un clúster en AWS en OpenShift Container Platform"^].
...
Siga la documentación de AWS para completar los pasos siguientes. Consulte https://["Documentación de instalación de AWS"^].
...
* https://["Introducción a Cloud Volumes ONTAP en AWS"^].
* https://["Cree un conector en AWS mediante BlueXP"^]
...
* https://["Instalar un clúster OpenShift en GCP"^]
* https://["Creación de una cuenta de servicio de GCP"^]
...
Consulte https://["Credenciales y permisos iniciales de GCP"^].
...
Siga la documentación de BlueXP para completar los siguientes pasos. Consulte https://["Introducción a Cloud Volumes ONTAP en GCP"^].
...
.Pasos
. Agregue sus credenciales a BlueXP. Consulte https://["Adición de cuentas de GCP"^].
. Agregue un conector para GCP.
+
.. Elija "GCP" como el proveedor.
.. Introduzca las credenciales de GCP. Consulte https://["Creación de un conector en GCP desde BlueXP"^].
...
* https://["Instalando el clúster de OpenShift en Azure"^].
* https://["Instalar una cuenta de Azure"^].
...
Consulte https://["Credenciales y permisos de Azure"^].
...
Siga la documentación de Azure para completar los siguientes pasos. Consulte https://["Instalando el clúster de OpenShift en Azure"^].
...
Siga la documentación de BlueXP para completar los siguientes pasos. Consulte https://["Introducción a BlueXP en Azure"^].
...
.Pasos
. Agregue sus credenciales a BlueXP.
. Agregue un conector para Azure. Consulte https://["Políticas de BlueXP"^].
+
...
+
Consulte https://["Creación de un conector en Azure desde BlueXPr"^].
