...
*¿Se desinstala automáticamente Astra Control Provisionador (o Astra Trident) de un clúster cuando lo desgestiono?*
...
* ¿Cómo puedo pasar de ser un usuario existente de Astra Trident a Astra Control para usar la gestión avanzada del almacenamiento y la funcionalidad de aprovisionamiento?*
